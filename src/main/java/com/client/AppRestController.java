...
public class AppRestController {
    ...
    public RedirectView processForm1() {
        ...
        String url = "https://hellotechnos.auth0.com/authorize"+
                    "?audience=https://hellotechnos.auth0.com/api/v2/"+
                    "&scope=openid%20profile"+
                    "&response_type=code"+
                    "&client_id=04iwGK25hChVTMf4h8weJbjgRcMmXuIM"+
    ...
    public String getAuthResponse(String authCode)
    {
        ...
        String POST_PARAMS = "grant_type=authorization_code"+
                            "&client_id=04iwGK25hChVTMf4h8weJbjgRcMmXuIM"+
                            "&client_secret=0_wDvG0GMA3cf2HjoMCRzPKwanOAFvBqqJM-v_CdTGoHkZcJD4x6_tUB8txTPfDe"+
                            "&code="+authCode+
                            "&redirect_uri=http%3A%2F%2Flocalhost%3A9999%2Foauth%2Faccess";
        String authReponse = "";
